const ru = {
  ...
  "signed": {
    ...
    "serverUpdate": {
      ...
      "bodyGeneric": "Сервер был обновлён. Перезагрузите приложение сейчас или позже в настройках.",
      "bodyFromTo": "Сервер был обновлён с {from} до {to}. Перезагрузите приложение сейчас или позже в настройках."
    },
    "settingsToast": {
